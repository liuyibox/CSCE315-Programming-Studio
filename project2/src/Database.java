...
//    }
    ...
    public void show(String relationName){
        try {
            ...
            System.out.println("\nRelation Name:\t" + table.getRelationName());
    ...
    public int[] conditionFunction(RelationTable table, Condition conditionTree){
        ...
        for(int conjuncIndex = 0; conjuncIndex < conditionTree.conjuncVec.size(); conjuncIndex++){

            List<Integer> tupleIndexList = new LinkedList<Integer>();

            Conjunction conjunction = conditionTree.conjuncVec.get(conjuncIndex);
    ...
    public void delete(String relationName, Condition conditionTree){
        RelationTable table = findRelationIndex(relationName);
        int[] indices = conditionFunction(table, conditionTree);
        ...
        {
            System.out.println("Delete: " + relationName + " -> " + e);
        }
    }
   ...
   // select will create a new table based on which tuples satisfy a particular condition
    ...
    public void select(String new_table_name, Condition conditions, String current_table_name){
        ...
        System.out.println("Indices where true condition: " + Integer.toString(indices[0]));
     ...
     * @param table_name The name of the RelationTable to modify.
    ...
    public void rename(String table_name, Vector<String> updated_names){
        RelationTable current = findRelationIndex(table_name);
        current.setAttributeNames(updated_names); //TODO: unsafe?
    }
    ...
    public void naturalJoin(String new_name, String table_name1, String table_name2){
        ...
        int count = 0; //TODO: unused
        int attr_index1 = 0, attr_index2 = 0;
        String new_table_name = ""; //TODO: unused
        loop:
    ...
    public static void main(String[] args) {
        ...
        //TODO: broken
        db1.select("dogs_with_gold_fur", null , "dogs_and_furs");
